  ...
  stages: [
    {
      ...
      items: [
        { file: "concepts/51-datenstrukturen-algorithmen.html", title: "51 · Datenstrukturen & Algorithmen", desc: "Arrays, Bäume, Graphen, Sortieren, Suchen, Big O — der Werkzeugkasten hinter jedem Programm." },
        { file: "concepts/52-systemarchitektur-design.html", title: "52 · Systemarchitektur & Design", desc: "Monolithen, Microservices, Serverless, event-getrieben, SOLID & GoF-Patterns." },
        { file: "concepts/53-betriebssysteme-netzwerke.html", title: "53 · Betriebssysteme & Netzwerke", desc: "Threads, Concurrency, Speicher, TCP/IP, HTTP/HTTPS, DNS, Sockets." },
        { file: "concepts/54-programmierparadigmen-sprachen.html", title: "54 · Programmierparadigmen & Sprachen", desc: "OOP, FP, imperativ vs. deklarativ; kompiliert vs. interpretiert vs. verwaltet." },
        { file: "concepts/55-software-engineering-lebenszyklus.html", title: "55 · Software-Engineering & Lebenszyklus", desc: "Agile, Scrum, Git-Branching, Code Review und die Test-Ebenen." },
        { file: "concepts/56-frontend-entwicklung.html", title: "56 · Frontend-Entwicklung", desc: "HTML/CSS/JS/TS, React & Co., Performance, PWAs, a11y, responsive." },
        { file: "concepts/57-backend-entwicklung.html", title: "57 · Backend-Entwicklung", desc: "REST/GraphQL/gRPC, Server-Frameworks, SQL- & NoSQL-Datenbanken." },
        { file: "concepts/58-devops-cloud.html", title: "58 · DevOps, Infrastruktur & Cloud", desc: "Docker/K8s, CI/CD, Cloud & IaC, Observability." },
        { file: "concepts/59-sicherheit-compliance.html", title: "59 · Sicherheit & Compliance", desc: "OWASP, AuthN/AuthZ, OAuth/OIDC/JWT, Kryptografie, Key-Management." },
        { file: "concepts/60-spezialisierte-domaenen.html", title: "60 · Spezialisierte Domänen", desc: "KI/ML, Mobile, Data Engineering, Embedded/IoT — eine Karte der Landschaft." },
      ],
    },
    {
      id: "A",
    ...
    },
    {
      ...
      items: [
        ...
        { file: "concepts/45-sampling-decoding.html", title: "45 · Sampling & Decoding", desc: "Temperatur, Top-p/Top-k, Greedy — wie aus Logits das nächste Wort wird." },
        { file: "concepts/46-kv-cache-inference-optimierung.html", title: "46 · KV-Cache & Inference-Optimierung", desc: "Warum Generation ohne Cache O(n²) wäre: KV-Cache, Batching, Throughput vs. Latenz." },
        { file: "concepts/47-attention-details.html", title: "47 · Attention-Details", desc: "Multi-Head, Cross-Attention, Positional Encoding — und warum √d_k skaliert." },
        { file: "concepts/48-retrieval-feintuning.html", title: "48 · Retrieval-Feintuning", desc: "Chunking-Strategien, Hybrid Search, Re-Ranking — RAG von „läuft“ zu „gut“." },
        { file: "concepts/49-agent-architekturen.html", title: "49 · Agent-Architekturen", desc: "ReAct vs. Plan-and-Execute, Framework-Vergleich, Agent-Eval." },
      ],
    },
  ],
