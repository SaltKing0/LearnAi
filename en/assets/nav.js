  ...
  stages: [
    {
      ...
      items: [
        { file: "concepts/51-data-structures-algorithms.html", title: "51 · Data Structures & Algorithms", desc: "Arrays, trees, graphs, sorting, searching, Big O — the toolbox behind every program." },
        { file: "concepts/52-system-architecture-design.html", title: "52 · System Architecture & Design", desc: "Monoliths, microservices, serverless, event-driven, SOLID & GoF patterns." },
        { file: "concepts/53-os-networking.html", title: "53 · Operating Systems & Networking", desc: "Threads, concurrency, memory, TCP/IP, HTTP/HTTPS, DNS, sockets." },
        { file: "concepts/54-programming-paradigms.html", title: "54 · Programming Paradigms & Languages", desc: "OOP, FP, imperative vs. declarative; compiled vs. interpreted vs. managed." },
        { file: "concepts/55-software-engineering-lifecycle.html", title: "55 · Software Engineering & Lifecycle", desc: "Agile, Scrum, Git branching, code review, and the testing levels." },
        { file: "concepts/56-frontend-development.html", title: "56 · Frontend Development", desc: "HTML/CSS/JS/TS, React & friends, performance, PWAs, a11y, responsive." },
        { file: "concepts/57-backend-development.html", title: "57 · Backend Development", desc: "REST/GraphQL/gRPC, server frameworks, SQL & NoSQL databases." },
        { file: "concepts/58-devops-cloud.html", title: "58 · DevOps, Infrastructure & Cloud", desc: "Docker/K8s, CI/CD, cloud & IaC, observability." },
        { file: "concepts/59-security-compliance.html", title: "59 · Security & Compliance", desc: "OWASP, authN/authZ, OAuth/OIDC/JWT, cryptography, key management." },
        { file: "concepts/60-specialized-domains.html", title: "60 · Specialized Domains", desc: "AI/ML, mobile, data engineering, embedded/IoT — a map of the landscape." },
      ],
    },
    {
      id: "A",
    ...
    },
    {
      ...
      items: [
        ...
        { file: "concepts/12-llm-apis-praktisch.html", title: "12 · LLM APIs Practically", desc: "System Prompt, Streaming, Tool-Calls via API — inference without GPU." },
    ...
    },
    {
      ...
      items: [
        { file: "concepts/15-evaluierung-metriken.html",     title: "15 · Evaluation & Metrics", desc: "Accuracy, Perplexity intuitively — why you want to compare models/prompts measurably." },
        { file: "concepts/16-halluzinationen-bias-limits.html", title: "16 · Hallucinations, Bias, Limits", desc: "Why models invent, mirror, and have hard limits (and countermeasures)." },
        { file: "concepts/17-kosten-latenz.html",            title: "17 · Cost & Latency",         desc: "Paid per token, quadratic attention — where money and time go." },
    ...
    },
    {
      ...
      items: [
        { file: "concepts/20-was-kann-ai-nicht.html",       title: "20 · What Can't AI Do?",        desc: "Structural limits: no consciousness, no experience, no real logic." },
        { file: "concepts/21-unterschied-verstehen.html",   title: "21 · Difference vs. Understanding",  desc: "Word network vs. experience network — why 'guessing' isn't 'understanding'." },
    ...
    },
    {
      ...
      items: [
        { file: "concepts/22-projekt-cli-chatbot.html",  title: "22 · CLI Chatbot",      desc: "First usable bot: API + System Prompt + Streaming + History." },
        { file: "concepts/23-projekt-mini-rag.html",     title: "23 · Mini-RAG",         desc: "Answer own data: Embeddings + Vector search + augmented Prompt." },
        { file: "concepts/24-projekt-attention-vis.html", title: "24 · Attention-Vis",    desc: "Build the heatmap from Concept 03 yourself (p5.js) — reading becomes making." },
    ...
    },
    {
      ...
      items: [
        ...
        { file: "concepts/45-sampling-decoding.html", title: "45 · Sampling & Decoding", desc: "Temperature, top-p/top-k, greedy — how logits become the next word." },
        { file: "concepts/46-kv-cache-inference-optimization.html", title: "46 · KV-Cache & Inference Optimization", desc: "Why generation would be O(n²) without it: KV-cache, batching, throughput vs. latency." },
        { file: "concepts/47-attention-details.html", title: "47 · Attention Details", desc: "Multi-head, cross-attention, positional encoding — and why the √d_k scaling." },
        { file: "concepts/48-retrieval-fine-tuning.html", title: "48 · Retrieval Fine-Tuning", desc: "Chunking strategies, hybrid search, re-ranking — taking RAG from 'works' to 'good'." },
        { file: "concepts/49-agent-architectures.html", title: "49 · Agent Architectures", desc: "ReAct vs. plan-and-execute, framework comparison, agent eval." },
      ],
    },
  ],
